...
package net.mcreator.genshincore.world.dimension;
...
public class GenshinCoreDimension {
	...
	public static class DimensionSpecialEffectsHandler {
		...
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(new ResourceLocation("genshin_core:genshin_core"), customEffect);
		}
	}
}
